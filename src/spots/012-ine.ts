...
export const defaultProps = {
  ...
  jaSubtitles: {
    catchCopy: "この家々は、人のために建てられたものじゃない。",
    hook: "まるでおとぎ話のような入江。水に浮かぶような家々。でも、人が住むために建てられたものじゃない。",
    facts: [
      "伊根の記録は1191年まで遡る。『方丈記』で知られる鴨長明も、この入江を歌に詠んだと言われている。",
      "舟屋は元々、住むための家じゃなかった。1階は船のガレージ、2階は物置。実際の住まいは道を挟んだ向かいに別にあった。",
      "約230軒の舟屋が、伊根湾5キロの海岸線に並ぶ。",
    ],
    twist: "平安の歌人が詠んだ漁村の風景は、今もほとんど変わらない。船のためのガレージが、いつしか暮らしそのものの形になった。そしてこの近くには、まだ2つの謎が待っている——天橋立と、元伊勢と呼ばれる籠神社。",
    outro: "元伊勢と呼ばれる籠神社——伊勢神宮の神が、南へ移る前に鎮座していたと伝わる場所。物語はまだ終わらない。",
  },
